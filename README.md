...
3. [Deployed to Netlify](https://docs.netlify.com/site-deploys/create-deploys/) and your [site's status badge][![Netlify Status](https://api.netlify.com/api/v1/badges/64c0489a-9980-4884-979a-7085807d0b36/deploy-status)](https://app.netlify.com/sites/rafiatdaodu/deploys) added to this file (`README.md`)
